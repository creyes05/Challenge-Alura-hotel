...
import logica.AccesoLogin;
import logica.DatosLogin;
import logica.NuevoUsuario;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		JButton btnRegistrar = new JButton("NUEVO USUARIO");
		...
		btnRegistrar.setFont(new Font("Dialog", Font.PLAIN, 18));
		btnRegistrar.setBounds(251, 431, 186, 44);
	...
	void Login() {
			...
			DatosLogin datos = new DatosLogin(usuario, contrasenia);
			datos.setUser(usuario);
			datos.setPass(contrasenia);
			
			AccesoLogin consulta = new AccesoLogin(usuario, contrasenia);
			consulta.entrar();
			dispose();
	...
	public void registrarUsuario() {
		...
		NuevoUsuario nUsuario = new NuevoUsuario(usuario, contrasenia);
		nUsuario.registrarUsuario();
	}
