...
import logica.DatosRegistroHuesped;
import logica.GenerarRegistroHuesped;
...
public class RegistroHuesped extends JFrame {
	...
	protected void guardar() {
		...
		String anioN = Integer.toString(txtFechaN.getCalendar().get(Calendar.YEAR)); 
		String mesN  = Integer.toString(txtFechaN.getCalendar().get(Calendar.MONTH) + 1 ); 
		String diasN = Integer.toString(txtFechaN.getCalendar().get(Calendar.DAY_OF_MONTH)); 
		String fechaNacimiento = anioN + "-" + mesN + "-" + diasN;
		String sNacionalidad = txtNacionalidad.getSelectedItem().toString();
		
		
		DatosRegistroHuesped datosRegistro = new DatosRegistroHuesped(nombre, apellido, fechaNacimiento, sNacionalidad,
			telefono, reserva);
		
		datosRegistro.setNombre(nombre);
		datosRegistro.setApellido(apellido);
		datosRegistro.setfNacimiento(fechaNacimiento);
		datosRegistro.setNacionalidad(sNacionalidad);
		datosRegistro.setTelefono(telefono);
		datosRegistro.setReserva(reserva);
		
		GenerarRegistroHuesped registro = new GenerarRegistroHuesped(nombre, apellido, fechaNacimiento, sNacionalidad, telefono, reserva);
